...
const DashboardService = {
  getDashboardData: () =>
    http.get(`${apiEndpoint}/all-users`, { headers: getAuthHeader() }),
  changeTechnician: (customerId: string, data: any) =>
    http.put(`${apiEndpoint}/update-assigned-technician/${customerId}`, data, {
      headers: getAuthHeader(),
    }),
  changeInstaller: (customerId: string, data: any) =>
    http.put(`${apiEndpoint}/update-assigned-installer/${customerId}`, data, {
      headers: getAuthHeader(),
    }),

  // customers apis
  getCustomersWithCurrentSteps: () =>
    http.get(`${apiEndpoint}/customers-current-steps`, {
      headers: getAuthHeader(),
    }),
  getCustomerDetails: (customerId: string) =>
    http.get(`${apiEndpoint}/customer-current-step/${customerId}`, {
      headers: getAuthHeader(),
    }),
  getAssignedTechnician: (customerId: string) =>
    http.get(`${apiEndpoint}/assigned-technician/${customerId}`, {
      headers: getAuthHeader(),
    }),
  getAssignedInstaller: (customerId: string) =>
    http.get(`${apiEndpoint}/assigned-installer/${customerId}`, {
      headers: getAuthHeader(),
    }),
  ...
  // admins apis
  getAllAdmins: () =>
    http.get(`${apiEndpoint}/admins`, { headers: getAuthHeader() }),
  getAllPSLs: () =>
    http.get(`${apiEndpoint}/get-all-psl`, { headers: getAuthHeader() }),
  getAllPSLsForAdminManager: () =>
    http.get(`${apiEndpoint}/get-all-psl-for-admin-manager`, {
      headers: getAuthHeader(),
    }),
  getPSLsOfAdminManager: (adminManagerId: string) =>
    http.get(`${apiEndpoint}/get-psls-of-admin-manager/${adminManagerId}`, {
      headers: getAuthHeader(),
    }),
  getRepresentativesOfPSL: (pslId: string) =>
    http.get(`${apiEndpoint}/get-representatives-of-psl/${pslId}`, {
      headers: getAuthHeader(),
    }),
  getInstallerManagersOfPSL: (pslId: string) =>
    http.get(`${apiEndpoint}/get-installer-managers-of-psl/${pslId}`, {
      headers: getAuthHeader(),
    }),
  getAllAdminManagers: () =>
    http.get(`${apiEndpoint}/get-all-admin-managers`, {
      headers: getAuthHeader(),
    }),
  getAllDirectors: () =>
    http.get(`${apiEndpoint}/get-all-all-directors`, {
      headers: getAuthHeader(),
    }),
  ...
  // installers apis
  getAllInstallers: () =>
    http.get(`${apiEndpoint}/installers`, { headers: getAuthHeader() }),
  addNewInstaller: (data: any) =>
    http.post(`${apiEndpoint}/add-installer`, data, {
      headers: { "Content-Type": "multipart/form-data", ...getAuthHeader() },
    }),
  getInstallerCustomers: (installerId: string) =>
    http.get(`${apiEndpoint}/installer-customers/${installerId}`, {
      headers: getAuthHeader(),
    }),

  // installer companies
  getAllInstallerCompanies: () =>
    http.get(`${apiEndpoint}/all-installer-companies`, {
      headers: getAuthHeader(),
    }),
  ...
  getInstallerCompanyDetails: (companyId: string) =>
    http.get(`${apiEndpoint}/get-installer-company-details/${companyId}`, {
      headers: getAuthHeader(),
    }),
  ...
  checkInstallerCompanyPostalCodeAvailability: (postalCode: string) =>
    http.get(`${apiEndpoint}/check-postal-code-availability/${postalCode}`, {
      headers: getAuthHeader(),
    }),

  // installer admins
  getAllInstallerAdmins: () =>
    http.get(`${apiEndpoint}/all-installer-admins`, {
      headers: getAuthHeader(),
    }),
  getAllInstallerAdminsByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-installer-admins-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  // Office managers
  getAllOfficeManagers: () =>
    http.get(`${apiEndpoint}/all-office-managers`, {
      headers: getAuthHeader(),
    }),
  getAllOfficeManagersByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-office-managers-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  getManagersOfOfficeManager: (officeManagerId: string) =>
    http.get(`${apiEndpoint}/managers-of-office-manager/${officeManagerId}`, {
      headers: getAuthHeader(),
    }),
  // Managers
  getAllManagers: () =>
    http.get(`${apiEndpoint}/all-managers`, { headers: getAuthHeader() }),
  getAllManagersForPSL: () =>
    http.get(`${apiEndpoint}/all-managers-for-psl`, {
      headers: getAuthHeader(),
    }),
  getAllManagersByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-managers-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  getRepresentativesOfManager: (managerId: string) =>
    http.get(`${apiEndpoint}/representatives-of-manager/${managerId}`, {
      headers: getAuthHeader(),
    }),
  // Representatives
  getAllRepresentatives: () =>
    http.get(`${apiEndpoint}/all-representatives`, {
      headers: getAuthHeader(),
    }),
  getAllRepresentativesForPSL: () =>
    http.get(`${apiEndpoint}/all-representatives-for-psl`, {
      headers: getAuthHeader(),
    }),
  getAllRepresentativesByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-representatives-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  getCustomersOfRepresentative: (representativeId: string) =>
    http.get(`${apiEndpoint}/customers-of-representative/${representativeId}`, {
      headers: getAuthHeader(),
    }),
  getAllTechniciansByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-technicians-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  // Customers
  getAllAssignedCustomers: () =>
    http.get(`${apiEndpoint}/all-assigned-customers`, {
      headers: getAuthHeader(),
    }),
  getAllAssignedCustomersByCompanyId: (companyId: string) =>
    http.get(`${apiEndpoint}/all-assigned-customers-of-company/${companyId}`, {
      headers: getAuthHeader(),
    }),
  getAllUnassignedCustomers: () =>
    http.get(`${apiEndpoint}/all-unassigned-customers`, {
      headers: getAuthHeader(),
    }),
  getAllUnassignedCustomersByCompanyId: (companyId: string) =>
    http.get(
      `${apiEndpoint}/all-unassigned-customers-of-company/${companyId}`,
      { headers: getAuthHeader() },
    ),
  getLogsOfCustomer: (customerId: string) =>
    http.get(`${apiEndpoint}/customer-logs/${customerId}`, {
      headers: getAuthHeader(),
    }),
  addLogComment: (data: any) =>
    http.post(`${apiEndpoint}/add-log-comment`, data, {
      headers: getAuthHeader(),
    }),

  assignRepresentative: (customerId: string, data: any) =>
    http.put(`${apiEndpoint}/assign-representative/${customerId}`, data, {
      headers: getAuthHeader(),
    }),
  assignCompany: (data: any) =>
    http.post(`${apiEndpoint}/assign-installer-company`, data, {
      headers: getAuthHeader(),
    }),
  changeOfficeManager: (managerId: string, data: any) =>
    http.put(`${apiEndpoint}/change-office-manager/${managerId}`, data, {
      headers: getAuthHeader(),
    }),
  changeManager: (representativeId: string, data: any) =>
    http.put(`${apiEndpoint}/change-manager/${representativeId}`, data, {
      headers: getAuthHeader(),
    }),

  getDetailsOfInstaller: (installerId: string) =>
    http.get(`${apiEndpoint}/installer-details/${installerId}`, {
      headers: getAuthHeader(),
    }),
  deleteInstallerById: (role: string, installerId: string) =>
    http.delete(`${apiEndpoint}/delete-installer/${installerId}`, {
      headers: getAuthHeader(),
    }),
  ...
  // technicians apis
  getAllTechnicians: () =>
    http.get(`${apiEndpoint}/all-technicians`, { headers: getAuthHeader() }),
  getTechnicianCustomers: (installerId: string) =>
    http.get(`${apiEndpoint}/customers-of-technician/${installerId}`, {
      headers: getAuthHeader(),
    }),
  getCustomerInstallerDetails: (userId: string) =>
    http.get(`${apiEndpoint}/user-installer-details/${userId}`, {
      headers: getAuthHeader(),
    }),
  getCustomerAccessToken: (data: { customerId: string }) =>
    http.post(`${apiEndpoint}/customer-access-token`, data, {
      headers: getAuthHeader(),
    }),
};
...
export const checkInstallerCompanyPostalCodeAvailability = (
  postalCode: string,
) => {
  return DashboardService.checkInstallerCompanyPostalCodeAvailability(
    postalCode,
  );
};
