...
const Representatives = () => {
  ...
  const [data, setData] = useState<{ representatives?: Array<any> }>({
    representatives: [],
  });
  ...
  const tableHeaders = [
    ...
    { text: "Company Name", key: "company", sortable: true },
    {
      ...
      customComponent: (props: any) =>
        props.fullObject.isEmailVerified ? "Verified" : "Not Verified",
    },
          ...
          menuOptions={[
            {
              ...
              onClick: () =>
                navigate(
                  allRoutes.VIEW_REPRESENTATIVE_DASHBOARD.replace(
                    ":id",
                    props.sequentialId
                  )
                ),
  ...
  return (
    <PageLayout loading={loading} hideBackButton>
      <TableBlock
        ...
        emptyStateMessage={
          "There are no representatives present. Please add a representative"
        }
        rowsPerPage={10}
      />
    </PageLayout>
