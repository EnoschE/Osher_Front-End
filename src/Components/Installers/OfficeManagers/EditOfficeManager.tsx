...
const EditOfficeManager = () => {
	...
	const handleUpdate = async (e: FormEvent<HTMLFormElement>) => {
		...
		try {
			...
			toast.success("Office manager updated successfully!");
			navigate(allRoutes.VIEW_OFFICE_MANAGER.replace(":id", id || ""));
		} catch (error: any) {
	...
	return (
		<PageLayout loading={loading}>
			<Typography variant="h5">Edit office manager</Typography>
			<Typography fontSize={15} mt={10}>
				Update photo and personal details of office manager
			</Typography>
...
export default EditOfficeManager;
