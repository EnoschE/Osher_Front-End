...
const OfficeManagers = () => {
  ...
  const [data, setData] = useState<{ officeManagers?: Array<any> }>({
    officeManagers: [],
  });
          ...
          menuOptions={[
            {
              ...
              onClick: () =>
                navigate(
                  allRoutes.VIEW_OFFICE_MANAGER_DASHBOARD.replace(
                    ":id",
                    props.sequentialId
                  )
                ),
  ...
  return (
    <PageLayout loading={loading} hideBackButton>
      <TableBlock
        ...
        emptyStateMessage={
          "There are no office managers present. Please add an office manager"
        }
        rowsPerPage={10}
      />
    </PageLayout>
